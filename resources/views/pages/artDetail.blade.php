...
<div class="grid grid-cols-4 md:grid-cols-12 mt-3 md:mt-24 text-center px-0 md:px-24 lg:px-28">
  <div class="col-span-4 md:col-span-12 lg:col-span-10 xl:col-span-8 lg:col-start-2 xl:col-start-3 h-fit">
    ...
    <div class="h-fit w-screen md:w-full bg-gradient-to-r md:bg-gradient-to-b from-galseid-orange to-galseid-yellow pt-2.5 md:p-2.5 md:rounded-3xl" style="min-height: 200px">
      <img src="https://upload.wikimedia.org/wikipedia/commons/4/4f/Raden_Saleh_-_Diponegoro_arrest.jpg" alt="Art Image" class="w-full h-fit object-cover md:rounded-2xl">
    </div>
    <div class="relative bg-gradient-to-b from-white via-white/80 to-white/0 md:bg-none mt-[-1.2rem] rounded-3xl px-7 sm:px-14 md:px-0 pb-16">
      <div class="relative grid grid-cols-[auto] lg:grid-cols-[auto_auto_auto] md:bg-galseid-blur md:rounded-3xl text-start align-top md:mx-20 lg:mx-14 md:mt-[-7rem] lg:mt-[-4rem] sm:px-4 pt-14 md:py-8 lg:py-5 z-100">
        <div class="grid grid-cols-[auto_1fr] grid-rows-[auto_1fr] gap-x-2 gap-y-0 text-galseid-dark px-5 mb-4 lg:mb-0 max-w-7x">
          <div class="">
            <i class="fas fa-images text-galseid-red-dark text-xl"></i>
          </div>
          <h2 class="font-header font-bold text-galseid-red-dark text-xl">Media</h2>
          <div></div>
          <p class="font-display font-bold text-galseid-dark mt-1">Canvas</p>
        </div>
        <div class="grid grid-cols-[auto_1fr] grid-rows-[auto_1fr] gap-x-2 gap-y-0 text-galseid-dark px-5 mb-4 lg:mb-0 max-w-7xl lg:border-r lg:border-l border-galseid-dark/25">
          <div class="flex justify-center items-center ">
            <i class="fas fa-pencil-ruler text-galseid-red-dark text-xl"></i>
          </div>
          <h2 class="font-header font-bold text-galseid-red-dark text-xl">Ukuran</h2>
          <div></div>
          <p class="font-display font-bold text-galseid-dark mt-1">100 x 200 cm</p>
        </div>
        <div class="grid grid-cols-[auto_1fr] grid-rows-[auto_1fr] gap-x-2 gap-y-0 text-galseid-dark px-5 max-w-7xl">
          <div class="">
            <i class="fas fa-paint-brush text-galseid-red-dark text-xl"></i>
          </div>
          <h2 class="font-header font-bold text-galseid-red-dark text-xl">Seniman</h2>
          <div></div>
          <p class="font-display font-bold text-galseid-dark mt-1">Raden Saleh Sjarif Boestaman</p>
        </div>
      </div>
      ...
      <div class="bg-galseid-red-dark/10 border-2 border-galseid-red-dark rounded-xl">
        ...
        <a href="https://id.wikipedia.org/wiki/Penangkapan_Pangeran_Diponegoro" class="w-full text-lg truncate hover:text-galseid-red-dark text-galseid-dark underline rounded-md leading-[2.5] px-4 mb-2">
